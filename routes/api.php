...
use App\Http\Controllers\CObservadaDetController;
use App\Http\Controllers\CObservadaBaseController;
...
use App\Http\Controllers\RiesgoNoEstructuralController;
...
use App\Http\Controllers\EdificacionEvaluacionPostsismicaController;
use App\Http\Controllers\EdificacionEvaluacionPresismicaController;
use App\Http\Controllers\IrregularidadHorizontalController;
use App\Http\Controllers\EvaluacionPresismicaOtroRiesgoController;
use App\Http\Controllers\EvaluacionPresismicaAccionRequeridaController;
use App\Http\Controllers\EvaluacionPresismicaEvaluacionDetalladaController;
use App\Http\Controllers\EvaluacionPostsismicaEvaluacionDetalladaController;
use App\Http\Controllers\EvaluacionPresismicaDetalladaModificadorController;
use App\Http\Controllers\EvaluacionPostsismicaSistemaConstruccionController;
use App\Http\Controllers\EvaluacionPresismicaIrregularidadVerticalController;
use App\Http\Controllers\EvaluacionPostsismicaCondicionObservadaBaseController;
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::apiResource('riesgo-no-estructural', RiesgoNoEstructuralController::class);
    Route::apiResource('c-observada-base', CObservadaBaseController::class);
    Route::apiResource('c-observada-det', CObservadaDetController::class);
    Route::apiResource('e-presismica-detallada-c-no-estructural', EvaluacionPresismicaDetalladaCNoEstructuralController::class)->parameters([
        'e-presismica-detallada-c-no-estructural' => 'presismica_ne'
    ]);
    Route::apiResource('e-presismica-detallada-modificador', EvaluacionPresismicaDetalladaModificadorController::class)->parameters([
        'e-presismica-detallada-modificador' => 'presismica_d'
    ]);
    Route::apiResource('evaluacion-presismica-accion-requerida', EvaluacionPresismicaAccionRequeridaController::class)->parameters([
        'evaluacion-presismica-accion-requerida' => 'evaluacion_presismica_ar'
    ]);
    ...
    Route::apiResource('evaluacion-presismica-irregularidad-vertical', EvaluacionPresismicaIrregularidadVerticalController::class)->parameters([
        'evaluacion-presismica-irregularidad-vertical' => 'evaluacion_presismica_iv'
    ]);
    Route::apiResource('evaluacion-presismica-otro-riesgo', EvaluacionPresismicaOtroRiesgoController::class)->parameters([
        'evaluacion-presismica-otro-riesgo' => 'evaluacion_presismica_or'
    ]);

    Route::apiResource('evaluacion-postsismica-condicion-observada-base', EvaluacionPostsismicaCondicionObservadaBaseController::class)->parameters([
        'evaluacion-postsismica-condicion-observada-base' => 'postsismica_cob'
    ]);

    Route::apiResource('evaluacion-postsismica-evaluacion-detallada', EvaluacionPostsismicaEvaluacionDetalladaController::class)->parameters([
        'evaluacion-postsismica-evaluacion-detallada' => 'postsismica_ed'
    ]);

    Route::apiResource('evaluacion-postsismica-sistema-construccion', EvaluacionPostsismicaSistemaConstruccionController::class)->parameters([
        'evaluacion-postsismica-sistema-construccion' => 'postsismica_sc'
    ]);

    Route::apiResource('edificacion-evaluacion-postsismica', EdificacionEvaluacionPostsismicaController::class)->parameters([
        'edificacion-evaluacion-postsismica' => 'edificacion_evaluacion_post'
    ]);

    Route::apiResource('edificacion-evaluacion-presismica', EdificacionEvaluacionPresismicaController::class)->parameters([
        'edificacion-evaluacion-presismica' => 'edificacion_evaluacion_pre'
    ]);
